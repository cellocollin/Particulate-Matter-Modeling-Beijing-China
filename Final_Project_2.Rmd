...
general = gls((Avg_Day_PM2.5^.101-1)/.101~., correlation = corAR1(form=~1:1460), data=na.omit(trainingdate))
summary(general)
#cant have na's
...
for (k in 1:366)
{
  testgeneral[k]=invBoxCox(testgeneral[k] , lambda )
}


rmse(nonatest[,2],testgeneral)
